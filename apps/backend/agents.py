...
with import_functions():
    from src.functions.my_custom_function import my_custom_function
    from src.functions.another_custom_function import another_custom_function
...
class AgentRag:
    ...
    async def run(self):
        ...
        await agent.step(lookupSales, "sales_data", start_to_close_timeout=timedelta(seconds=10))
